import combine
import combine.combine_core as core
import numpy as np
...
def test_to_sample_major():
    ...
    actual = combine.to_sample_major(mat, n_threads=n_threads)
...
def test_calldata_sum():
    ...
    actual = combine.calldata_sum(mat, n_threads=n_threads)
...
def test_subset_rows_cols():
    ...
    actual = combine.calldata_subset_rows_cols(mat, row_indices, col_indices, n_threads)
